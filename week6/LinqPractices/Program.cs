...
namespace LinqPractices
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            student = _context.Students.Where(student => student.Surname == "Şentürk").FirstOrDefault();
            Console.WriteLine(student.Name);

            student = _context.Students.FirstOrDefault(x => x.Surname == "Şentürk");
            Console.WriteLine(student.Name);

            //SingleOrDefault()
            Console.WriteLine();
            Console.WriteLine("---- SingleOrDefault ----");
            student = _context.Students.SingleOrDefault(student => student.Name == "Berke");
